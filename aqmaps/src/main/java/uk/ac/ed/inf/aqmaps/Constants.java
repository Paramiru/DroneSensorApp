...
public class Constants {
	...
	protected static final Coordinate[] CONFINED_AREA_POLYGON = new Coordinate[] { Constants.TOP_LEFT, 
			Constants.TOP_RIGHT, Constants.BOTTOM_RIGHT, Constants.BOTTOM_LEFT, Constants.TOP_LEFT };
	protected static final Polygon CONFINED_AREA = Utils.geometryFactory.createPolygon(CONFINED_AREA_POLYGON);
